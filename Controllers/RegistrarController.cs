...

    {
                                                                ...
                                                                string email, string nome)
        {
            ...
            var data = aList.Select(x => new
            {
                ...
                perfil = x.TP_USUARIO == Enums.TP_USUARIO.Administrador ? "Administrador" : x.TP_USUARIO == Enums.TP_USUARIO.Usuariocadastro ? "Cadastro usuário" : x.TP_USUARIO == Enums.TP_USUARIO.Usuarioconsulta ? "Consulta usuário" : "Padrão",
