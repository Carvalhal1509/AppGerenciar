...

    {
                                                                ...
                                                                string email, string nome)
        {
            ...
            var data = aList.Select(x => new
            {
                ...
                perfil = x.Perfil == Enums.TP_USUARIO.Administrador ? "Administrador" : x.Perfil == Enums.TP_USUARIO.Usuariocadastro ? "Cadastro usuário" : x.Perfil == Enums.TP_USUARIO.Usuarioconsulta ? "Consulta usuário" : "Padrão",
